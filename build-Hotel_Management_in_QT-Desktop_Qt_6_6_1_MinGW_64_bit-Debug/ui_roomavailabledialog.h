...
public:
    ...
    void setupUi(QDialog *RoomAvailableDialog)
    {
        ...
        lblinfo->setGeometry(QRect(40, 170, 81, 16));
    ...
    void retranslateUi(QDialog *RoomAvailableDialog)
    {
        ...
        groupBox->setTitle(QCoreApplication::translate("RoomAvailableDialog", "Disponibilt\303\251 des chambres", nullptr));
        ...
        lblinfo->setText(QCoreApplication::translate("RoomAvailableDialog", "disponible", nullptr));
    } // retranslateUi
